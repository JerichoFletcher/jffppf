...
describe("A* pathfinder test for maps", () => {
  const rooms = [
    new RectRoom({ x: 0, y: 0 }, { x: 3, y: 3 }, "room_astar-pathfinder-map_test-00_foo"),
    new RectRoom({ x: 3, y: 0 }, { x: 6, y: 6 }, "room_astar-pathfinder-map_test-00_bar"),
    new RectRoom({ x: 0, y: 3 }, { x: 3, y: 6 }, "room_astar-pathfinder-map_test-00_qux"),
    new RectRoom({ x: 6, y: 0 }, { x: 9, y: 6 }, "room_astar-pathfinder-map_test-00_unreachable"),
  ];
  const links = [
    new DoorLink(
      { point: { x: 2.9, y: 1 }, room: rooms[0] },
      { point: { x: 3.1, y: 1 }, room: rooms[1] },
      "door_astar-pathfinder-map_test-00_foo-bar"
    ),
    new DoorLink(
      { point: { x: 3.1, y: 5 }, room: rooms[1] },
      { point: { x: 2.9, y: 5 }, room: rooms[2] },
      "door_astar-pathfinder-map_test-00_bar-qux"
    ),
  ];
  ...
  test("Pathfinding test on complex map", () => {
    const rooms2 = [
      new RectRoom({ x: 50, y: 50 }, { x: 300, y: 200 }, "room_astar-pathfinder_test-06_SW"),
      new RectRoom({ x: 300, y: 100 }, { x: 450, y: 200 }, "room_astar-pathfinder_test-06_SW_MID"),
      new RectRoom({ x: 500, y: 150 }, { x: 650, y: 250 }, "room_astar-pathfinder_test-06_SE"),
      new RectRoom({ x: 250, y: 250 }, { x: 450, y: 450 }, "room_astar-pathfinder_test-06_CENTER"),
      new RectRoom({ x: 100, y: 250 }, { x: 250, y: 350 }, "room_astar-pathfinder_test-06_CENTER_SIDE_1"),
      new RectRoom({ x: 100, y: 350 }, { x: 250, y: 450 }, "room_astar-pathfinder_test-06_CENTER_SIDE_2"),
      new PolygonRoom([
        { x: 450, y: 250 },
        { x: 450, y: 500 },
        { x: 550, y: 500 },
        { x: 650, y: 400 },
        { x: 650, y: 250 },
      ], "room_astar-pathfinder_test-06_NE"),
      new PolygonRoom([
        { x: 450, y: 500 },
        { x: 450, y: 450 },
        { x: 100, y: 450 },
