...
export default abstract class Pathfinder{
   ...
   */
  public abstract findPathToRoom(map: RoomMap, src: Vec2Like, dest: Room): Vec2Like[];
   ...
   * @returns An array of points along which the result path goes, or an empty array if no such path exists.
   */
  public abstract findPathToPoint(map: RoomMap, src: Vec2Like, dest: Vec2Like): Vec2Like[];
   ...
   * @returns An array of points along which the result path goes, or an empty array if no such path exists.
   */
  public abstract findPathInRoom(room: Room, src: Vec2Like, dest: Vec2Like): Vec2Like[];
}